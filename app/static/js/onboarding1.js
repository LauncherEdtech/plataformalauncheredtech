...
// Sistema de Onboarding - Modais Guiados
// ✅ VERSÃO 100% CORRIGIDA - 2026-02-18
        ...
        if (!this.dadosEtapa) {
            ...
            if (status?.dados_etapa) {
                ...
                this.dadosEtapa = {
                    ...
                    descricao: 'Você já conhece o essencial da plataforma! Quer fazer o tour completo e ganhar 100 💎 extras?',
                    rota_destino: null,
                    acao_necessaria: 'escolher_proximo_passo',
                    recompensa: { xp: 0, diamantes: 0 },
                    opcoes: [
                        { texto: '🚀 Começar a Estudar', acao: 'finalizar_basico' },
                        { texto: '📚 Fazer Tour Completo (+100 💎)', acao: 'continuar_tour_completo' },
        ...
        this.modal.innerHTML = `
            ...
            <div class="onboarding-body">
                ...
                <div class="onboarding-actions" style="margin-top: 20px;">
                    <button class="onboarding-btn onboarding-btn-secondary" onclick="onboardingManager.hideTemporarily()">
                        🔽 Minimizar (Preencher Form)
                    </button>
                </div>
            </div>
        `;
        ...
        this.modal.innerHTML = `
            ...
            <div class="onboarding-body">
                ...
                <div class="onboarding-actions">
                    ...
                    <button type="button"
                            data-onboarding="btn-tour-completo"
                ...
                <a href="#" onclick="window.onboardingManager.adiarTour(); return false;">
                    Fazer depois
                </a>
            </div>
        `;
            ...
            <div class="onboarding-body">
                ...
                <div class="onboarding-actions" style="margin-top: 20px;">
                    <button class="onboarding-btn onboarding-btn-secondary" 
                            onclick="onboardingManager.hideTemporarily()">
                        🔽 Minimizar (Criar Post)
                    </button>
                    <button class="onboarding-btn onboarding-btn-primary" 
    ...
    showRedacao() {
        this.modal.innerHTML = `
            ...
            <div class="onboarding-body">
                ...
                <div class="onboarding-actions" style="margin-top: 20px; flex-direction: column; gap: 10px; display: flex;">
                    <button class="onboarding-btn onboarding-btn-primary" 
...
async finalizarBasico() {
    ...
    try {
        // ✅ MUDAR DE /pular PARA /finalizar-permanente
